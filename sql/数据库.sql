...
promo VARCHAR(255) COMMENT '提示文字',
link VARCHAR(500) COMMENT '链接地址',
image VARCHAR(255) COMMENT '封面图片地址',
...
store_link VARCHAR(255) COMMENT '商店的链接',
brand VARCHAR(255) COMMENT '品牌名称',
brand_link VARCHAR(255) COMMENT '品牌的链接',
...
logo VARCHAR(255) NOT NULL COMMENT '图标的链接地址',
link VARCHAR(255) NOT NULL COMMENT '商店的链接地址',
display_order INT UNSIGNED NOT NULL COMMENT '展示的顺序',
